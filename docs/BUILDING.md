...
The full test suite covers 268 tests across four executables:
...
```
com0com\build\tests\Debug\setup_tests.exe      # 86 tests (setup.dll: params, comdb, mocks, integration, null-modem)
