...
The full test suite covers 267 tests across four executables:
...
```
com0com\build\tests\Debug\setup_tests.exe      # 85 tests (setup.dll: params, comdb, mocks, integration, null-modem)
